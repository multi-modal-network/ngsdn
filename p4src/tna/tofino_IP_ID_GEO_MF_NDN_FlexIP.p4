...
#include "common/packetio.p4"
#include "common/table0.p4"
...
control ingress(
   ...
   action set_next_v6_hop(PortId_t dst_port) {
    ...
    apply {
        ...
        pkt_io.apply(hdr, ig_md, ig_intr_md, ig_tm_md, ig_dprsr_md); 
        table0.apply(hdr, ig_md, ig_intr_md, ig_tm_md, ig_dprsr_md);
